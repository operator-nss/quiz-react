...
const QuizContainer: FC = () => {
  ...
  return (
    <main className="container">
      <div className="relative mx-auto mt-10 max-w-5xl rounded-lg border bg-white py-8 px-5 md:px-10">
        <div className="mb-8 flex flex-wrap items-center gap-5 md:flex-nowrap">
        ...
        <img
          className="animate__01  absolute top-10 -right-40 -z-10 hidden rounded-lg shadow xl:block"
          src={bg01}
          alt=""
        />
        <img
          className="animate__02  absolute top-10 -left-60 -z-10 hidden rounded-lg shadow xl:block"
          src={bg02}
          alt=""
        />
        <img
          className="animate__03  absolute bottom-10 -left-40 -z-10 hidden rounded-lg shadow xl:block"
          src={bg03}
          alt=""
        />
        <img
          className="animate__04  absolute bottom-10 -right-60 -z-10 hidden rounded-lg shadow xl:block"
          src={bg04}
          alt=""
        />
        <img
          className="animate__05 absolute top-1/2  -left-60 -z-10 hidden rounded-lg shadow xl:block"
          src={bg05}
          alt=""
        />
        <img
          className="animate__06 absolute top-1/3 -right-60 -z-10 hidden rounded-lg shadow xl:block"
          src={bg06}
          alt=""
        />
        <img
          className="animate__07  absolute top-10 -left-60 -z-10 hidden rounded-lg shadow xl:block"
          src={bg07}
          alt=""
        />
